...
--
-- Host: 127.0.0.1    Database: oo2_tp_bbdd
-- ------------------------------------------------------
...
CREATE TABLE `cuota` (
  ...
  PRIMARY KEY (`idCuota`),
  KEY `cuota_ibfk_1` (`idPrestamo`),
  CONSTRAINT `cuota_ibfk_1` FOREIGN KEY (`idPrestamo`) REFERENCES `prestamo` (`idPrestamo`)
...
-- Dump completed on 2024-04-15 21:26:11
